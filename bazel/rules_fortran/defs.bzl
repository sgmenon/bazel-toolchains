...
load("//gcc_toolchain/fortran:action_names.bzl", "ACTION_NAMES")
...
_attrs = {
    ...
    "_fortran_toolchain_type": attr.label(default = "//gcc_toolchain/fortran:toolchain_type"),
}
...
fortran_binary = rule(
    ...
    executable = True,
    fragments = ["cpp"],
    toolchains = ["//gcc_toolchain/fortran:toolchain_type"],
)
